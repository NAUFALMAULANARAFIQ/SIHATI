    ...
    <div class="min-h-full flex">
        <div class="hidden lg:flex lg:w-1/2 xl:w-[55%] bg-sihati-navy items-center justify-center p-8 xl:p-12 relative overflow-hidden">
            <div class="absolute inset-0 overflow-hidden pointer-events-none">
                <div class="absolute -top-20 -right-20 w-72 h-72 opacity-[0.03]">
                    <svg viewBox="0 0 200 200" fill="#5645D4" class="w-full h-full">
                        <path d="M100 0L200 100L100 200L0 100Z"/>
                    </svg>
                </div>
                <div class="absolute -bottom-24 -left-24 w-80 h-80 opacity-[0.02] rotate-45">
            ...
            <div class="relative z-10 max-w-lg text-center">
                <div class="mb-6">
                    ...
                    <img src="{{ asset('images/logo-sihati-horizontal.png') }}" alt="SIHATI BPPKAD" class="h-14 mx-auto mb-6">
                    @else
                    <div class="inline-flex items-center justify-center w-20 h-20 bg-sihati-primary rounded-2xl mb-6 shadow-lg">
                        <svg class="w-11 h-11 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                    </div>
                    @endif
                    <h1 class="text-4xl xl:text-5xl font-bold mb-3 tracking-tight text-sihati-on-dark">
                        <span>SIHATI</span> <span class="text-sihati-on-dark-muted">BPPKAD</span>
                    </h1>
