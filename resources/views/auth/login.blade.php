            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" id="password" name="password" placeholder="Masukkan kata sandi" required
                        class="h-11 w-full rounded-md border border-sihati-hairline-strong bg-sihati-canvas px-4 pr-10 text-sm text-sihati-ink placeholder:text-sihati-stone focus:border-sihati-primary focus:outline-none focus:ring-2 focus:ring-sihati-primary/20 @error('password') border-sihati-error @enderror">
